...
class AudioEngine {
    ...
    concatAudio(buffer1, buffer2) {
        ...
        const newBuffer = this.audioContext.createBuffer(channels, totalLength, sampleRate);
    ...
    mixAudio(buffer1, buffer2) {
        ...
        const newBuffer = this.audioContext.createBuffer(channels, maxLength, sampleRate);
    ...
    resampleBuffer(buffer, targetSampleRate, targetChannels) {
        ...
        const newBuffer = this.audioContext.createBuffer(targetChannels, newLength, targetSampleRate);
